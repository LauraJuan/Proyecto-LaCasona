...
public class Reservas extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			OperacionesDAO.reserva(fecha_reserva, fecha_entrada, fecha_salida, num_personas, idCliente, tipoHab, extra);
			
			List<Reserva> lista = OperacionesDAO.getReservaOfCliente(idCliente);
